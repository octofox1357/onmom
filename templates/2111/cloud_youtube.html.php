    ...
    <div class="opacity-extra-medium bg-gradient-peacock-blue-crome-yellow"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-7 col-lg-8 col-md-10 text-center padding-five-tb">
                        <h3 class="alt-font text-white font-weight-600 margin-35px-bottom">구름공장 영상 매거진</h3>
        ...
        <iframe allow="autoplay" src="https://www.youtube.com/embed/videoseries?list=PLAlE27UkFjk3-N5u0aKKQMfHLjLOzgCss&rel=0&amp;showinfo=0&background=1&autoplay=1&loop=1&mute=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
        </section>
        <!-- end section -->
